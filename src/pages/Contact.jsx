...
const Contact = () => {
  return (
    <section className="min-h-screen pt-28 pb-20 bg-background text-primary">
      <Helmet>
      ...
      <div className="container">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            Contact <span className="text-primary">NexCart</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Glass Card */}
            <div className="bg-background-secondary backdrop-blur-xl border border-primary/20 rounded-3xl p-8 shadow-xl">
          ...
          {/* RIGHT — CONTACT FORM */}
          <div className="bg-white/70 backdrop-blur-xl border border-primary/20 rounded-3xl p-8 shadow-xl">
